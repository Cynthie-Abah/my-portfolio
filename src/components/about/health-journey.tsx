  ...
  return (
    ...
    <div className="relative py-2">
      ...
      <div className="italic text-gray-400 mb-8 w-[90%] md:w-[70%] mx-auto text-[1.05rem]">
        My love for nuturing and caring for people started early. As a child, I was always drawn to helping people feel better, whether it was tending to a someone who wasn't feeling well or staying close and offering emotional relief.
      </div>
